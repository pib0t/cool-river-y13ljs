...
function convertDesignTokensToStyles(tokens) {
  ...
  for (var key in tokens) {
    ...
    if (_typeof(value) === "object") {
      ...
      var nestedStyles = convertDesignTokensToStyles(value, "".concat(prefix).concat(key, "-"));
      styles += nestedStyles;
    } else {
      // Generate CSS style based on the token name and value
      var style = "--".concat(prefix).concat(key, ": ").concat(value, ";\n");
      styles += style;
    }
  }
  return styles;
...
var cssStyles = convertDesignTokensToStyles(designTokens);
